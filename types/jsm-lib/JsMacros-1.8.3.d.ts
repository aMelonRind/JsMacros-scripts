 ...
 * ```
 */
// since my script are mostly key or service
// event script are just for testing so i'll just default this to service
declare const event: Events.Service;
...
declare namespace Events {
  ...
  interface JoinServer extends BaseEvent {
    readonly player: ClientPlayerEntityHelper</* net.minecraft.client.network.ClientPlayerEntity */ any>;
  ...
  interface CodeRender extends BaseEvent {
     ...
     */
    rightClickActions: MethodWrapper<number, any, JavaMap<string, MethodWrapper>>;

    /**
     * @return [Prism4j's node list](https://github.com/noties/Prism4j/blob/75ac3dae6f8eff5b1b0396df3b806f44ce86c484/prism4j/src/main/java/io/noties/prism4j/Prism4j.java#L54)  
     *      you don't have to use it but if you're not compiling your own...
     ...
     */
    createSuggestion(startIndex: int, suggestion: string, displayText: TextHelper): AutoCompleteSuggestion;
  ...
  interface Custom extends BaseEvent {
     ...
     */
    trigger(callback: MethodWrapper): void;
...
declare namespace Client {
   ...
   * @since 1.4.0
   */
  function runOnMainThread(runnable: MethodWrapper): void;
   ...
   */
  function runOnMainThread(runnable: MethodWrapper, watchdogMaxTime: long): void;
   ...
   */
  function disconnect(callback: MethodWrapper<boolean>): void;
   ...
   * @throws UnknownHostException
   */
  function pingAsync(ip: string, callback: MethodWrapper<ServerInfoHelper, Packages.java.io.IOException>): void;
  /** @since 1.6.5 */
...
declare namespace Hud {
  ...
  /**
   * Opens a {@link xyz.wagyourtail.jsmacros.client.api.sharedinterfaces.IScreen} Object.
   * @since 1.0.5
   * @see xyz.wagyourtail.jsmacros.client.api.sharedinterfaces.IScreen
   * @param s
   */
...
declare namespace Player {
   ...
   * @since 1.0.3
   */
  function getPlayer(): ClientPlayerEntityHelper</* net.minecraft.client.network.ClientPlayerEntity */ any>;
   ...
   * @since 1.0.5
   */
  function rayTraceBlock(distance: double, fluid: boolean): BlockDataHelper;
   ...
   */
  function rayTraceEntity(distance: int): EntityHelper;
   ...
   * @since 1.2.6
   */
  function takeScreenshot(folder: string, callback: MethodWrapper<TextHelper>): void;
   ...
   * @since 1.2.6
   */
  function takeScreenshot(folder: string, file: string, callback: MethodWrapper<TextHelper>): void;
   ...
   * @since 1.4.0
   */
  function createPlayerInput(movementForward: double, movementSideways: double, yaw: double): PlayerInput;
   ...
   * @since 1.4.0
   */
  function createPlayerInput(movementForward: double, yaw: double, jumping: boolean, sprinting: boolean): PlayerInput;
   ...
   * @since 1.4.0
   */
  function createPlayerInput(movementForward: double, movementSideways: double, yaw: double, pitch: double, jumping: boolean, sneaking: boolean, sprinting: boolean): PlayerInput;
   ...
   * @since 1.4.0
   */
  function predictInput(input: PlayerInput, draw: boolean): PositionCommon$Pos3D;
   ...
   * @since 1.4.0
   */
  function predictInputs(inputs: PlayerInput[], draw: boolean): JavaList<PositionCommon$Pos3D>;
   ...
   * @since 1.4.0
   */
  function moveForward(yaw: float): void;
   ...
   * @since 1.4.0
   */
  function moveBackward(yaw: float): void;
   ...
   * @since 1.4.2
   */
  function moveStrafeLeft(yaw: float): void;
   ...
   * @since 1.4.2
   */
  function moveStrafeRight(yaw: float): void;
...
declare namespace PositionCommon {
   ...
   * @return
   */
  function createVec(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double): PositionCommon$Vec3D;
   ...
   * @return
   */
  function createVec(x1: double, y1: double, x2: double, y2: double): PositionCommon$Vec2D;
   ...
   * @return
   */
  function createPos(x: double, y: double, z: double): PositionCommon$Pos3D;
   ...
   * @return
   */
  function createPos(x: double, y: double): PositionCommon$Pos2D;
...
declare namespace World {
   ...
   */
  function getLoadedPlayers(): JavaList<PlayerEntityHelper</* net.minecraft.entity.player.PlayerEntity */ any>>;
   ...
   */
  function getBlock(x: int, y: int, z: int): BlockDataHelper;
   ...
   * @since 1.6.5
   */
  function getWorldScanner(blockFilter: MethodWrapper<BlockHelper, any, boolean>, stateFilter: MethodWrapper<BlockStateHelper, any, boolean>): WorldScanner;
   ...
   * @return
   */
  function findBlocksMatching(centerX: int, centerZ: int, id: BlockId, chunkrange: int): JavaList<PositionCommon$Pos3D>;
   ...
   * @return
   */
  function findBlocksMatching(id: BlockId, chunkrange: int): JavaList<PositionCommon$Pos3D>;
   ...
   * @return
   */
  function findBlocksMatching(ids: BlockId[], chunkrange: int): JavaList<PositionCommon$Pos3D>;
   ...
   * @return
   */
  function findBlocksMatching(centerX: int, centerZ: int, ids: BlockId[], chunkrange: int): JavaList<PositionCommon$Pos3D>;
   ...
   * @return
   */
  function findBlocksMatching(blockFilter: MethodWrapper<BlockHelper, any, boolean>, stateFilter: MethodWrapper<BlockStateHelper, any, boolean>, chunkrange: int): JavaList<PositionCommon$Pos3D>;
   ...
   * @return
   */
  function findBlocksMatching(chunkX: int, chunkZ: int, blockFilter: MethodWrapper<BlockHelper, any, boolean>, stateFilter: MethodWrapper<BlockStateHelper, any, boolean>, chunkrange: int): JavaList<PositionCommon$Pos3D>;
   ...
   * @return
   */
  function rayTraceBlock(x1: int, y1: int, z1: int, x2: int, y2: int, z2: int, fluid: boolean): BlockDataHelper;
   ...
   * @return
   */
  function rayTraceEntity(x1: int, y1: int, z1: int, x2: int, y2: int, z2: int): EntityHelper;
...
declare namespace JavaWrapper {
   ...
   */
  function methodToJava<A, B, R>(c: (arg0: A, arg1: B) => R | void): MethodWrapper<A, B, R>;
   ...
   * @return a new {@link MethodWrapper MethodWrapper}
   */
  function methodToJavaAsync<A, B, R>(c: (arg0: A, arg1: B) => R | void): MethodWrapper<A, B, R>;
   ...
   * @return 
   */
  function methodToJavaAsync<A, B, R>(priority: int, c: (arg0: A, arg1: B) => R | void): MethodWrapper<A, B, R>;
...
declare namespace JsMacros {
   ...
   * @since 1.4.0
   */
  function getOpenContexts(): JavaList<BaseScriptContext>;
   ...
   * @return
   */
  function runScript(file: string): EventContainer;
   ...
   * @return
   */
  function runScript(file: string, fakeEvent: Events.BaseEvent): EventContainer;
   ...
   */
  function runScript(file: string, fakeEvent: Events.BaseEvent, callback: MethodWrapper<Packages.java.lang.Throwable>): EventContainer;
   ...
   * @return
   */
  function runScript(language: string, script: string): EventContainer;
   ...
   */
  function runScript(language: string, script: string, callback: MethodWrapper<Packages.java.lang.Throwable>): EventContainer;
   ...
   * @return
   */
  function runScript(language: string, script: string, file: string, callback: MethodWrapper<Packages.java.lang.Throwable>): EventContainer;
   ...
   * @return
   */
  function runScript(language: string, script: string, file: string, event: Events.BaseEvent, callback: MethodWrapper<Packages.java.lang.Throwable> | null): EventContainer;
   ...
   * @return 
   */
  function wrapScriptRun<T, U, R>(file: string): MethodWrapper<T, U, R>;
   ...
   * @return 
   */
  function wrapScriptRun<T, U, R>(language: string, script: string): MethodWrapper<T, U, R>;
   ...
   * @return 
   */
  function wrapScriptRun<T, U, R>(language: string, script: string, file: string): MethodWrapper<T, U, R>;
   ...
   * @return 
   */
  function wrapScriptRunAsync<T, U, R>(file: string): MethodWrapper<T, U, R>;
   ...
   * @return 
   */
  function wrapScriptRunAsync<T, U, R>(language: string, script: string): MethodWrapper<T, U, R>;
   ...
   * @return 
   */
  function wrapScriptRunAsync<T, U, R>(language: string, script: string, file: string): MethodWrapper<T, U, R>;
   ...
   * @return
   */
  function on<E extends keyof Events>(event: E, callback: MethodWrapper<Events[E], EventContainer>): IEventListener;
   ...
   * @return the listener.
   */
  function once<E extends keyof Events>(event: E, callback: MethodWrapper<Events[E], EventContainer>): IEventListener;
   ...
   * @return
   */
  function off(event: keyof Events, listener: IEventListener): boolean;
   ...
   * @throws InterruptedException
   */
  function waitForEvent<E extends keyof Events>(event: E): FJsMacros$EventAndContext<E>;
   ...
   * @throws InterruptedException
   */
  function waitForEvent<E extends keyof Events>(event: E, filter: MethodWrapper<Events[E], undefined, boolean>): FJsMacros$EventAndContext<E>;
   ...
   * @throws InterruptedException
   */
  function waitForEvent<E extends keyof Events>(event: E, filter: MethodWrapper<Events[E], undefined, boolean>, runBeforeWaiting: MethodWrapper<JavaObject, JavaObject, JavaObject>): FJsMacros$EventAndContext<E>;
...
declare namespace Reflection {
   ...
   * @return
   */
  function createClassProxyBuilder<T>(clazz: JavaClassArg<T>, ...interfaces: JavaClassArg<any>[]): ProxyBuilder<T>;
   ...
   */
  function createClassBuilder<T>(cName: string, clazz: JavaClassArg<T>, ...interfaces: JavaClassArg<any>[]): ClassBuilder<T>;
  ...
  function createLibraryBuilder(name: string, perExec: boolean, ...acceptedLangs: string[]): LibraryBuilder;
   ...
   * @throws ClassNotFoundException
   */
  function getWrappedClass(className: string): WrappedClassInstance;
...
declare namespace Request {
   ...
   * @throws IOException
   */
  function get(url: string, headers: JavaMap<string, string>): HTTPRequest$Response;
   ...
   * @throws IOException
   */
  function post(url: string, data: string, headers: JavaMap<string, string>): HTTPRequest$Response;
...
declare namespace Packages {
  ...
  namespace xyz.wagyourtail {
    ...
    interface StringHashTrie extends java.lang.Object, JavaCollection<java.lang.String> {
  ...
  namespace xyz.wagyourtail {
    ...
    namespace jsmacros {
      ...
      namespace core {
         ...
         * @author Wagyourtail
         */
        const MethodWrapper: JavaClassStatics<MethodWrapper, MethodWrapper$$constructor>;
        interface MethodWrapper$$constructor extends SuppressProperties {

          new <T, U, R, C extends BaseScriptContext>(containingContext: C): MethodWrapper<T, U, R, C>;

        }
        interface MethodWrapper<T, U, R, C extends BaseScriptContext> extends java.lang.Object, java.util.function.Consumer<T>, java.util.function.BiConsumer<T, U>, java.util.function.Function<T, R>, java.util.function.BiFunction<T, U, R>, java.util.function.Predicate<T>, java.util.function.BiPredicate<T, U>, java.lang.Runnable, java.util.function.Supplier<R>, java.util.Comparator<T> {
        ...
        const Core: JavaClassStatics<Core> & NoConstructor & {
           ...
           * @return
           */
          createInstance<V extends BaseProfile, R extends BaseEventRegistry>(eventRegistryFunction: java.util.function.Function<Core<V, R>, R>, profileFunction: java.util.function.BiFunction<Core<V, R>, org.slf4j.Logger, V>, configFolder: java.io.File, macroFolder: java.io.File, logger: org.slf4j.Logger): Core<V, R>;

        }
        interface Core<T extends BaseProfile, U extends BaseEventRegistry> extends java.lang.Object {
           ...
           * @param container
           */
          addContext(container: EventContainer): void;

          /**
           * @return
           */
          getContexts(): JavaSet<BaseScriptContext>;
           ...
           * @return
           */
          exec(macro: ScriptTrigger, event: Events.BaseEvent): EventContainer;
           ...
           * @return
           */
          exec(macro: ScriptTrigger, event: Events.BaseEvent, then: java.lang.Runnable, catcher: java.util.function.Consumer<java.lang.Throwable>): EventContainer;
           ...
           * @return
           */
          exec(lang: string, script: string, fakeFile: java.io.File, event: Events.BaseEvent, then: java.lang.Runnable, catcher: java.util.function.Consumer<java.lang.Throwable>): EventContainer;
           ...
           * @return
           */
          wrapException(ex: java.lang.Throwable): BaseWrappedException;
      ...
      namespace core {
        ...
        namespace language {
          ...
          /** @since 1.4.0 */
          const BaseScriptContext: JavaClassStatics<BaseScriptContext, BaseScriptContext$$constructor>;
          ...
          interface BaseScriptContext<T> extends java.lang.Object {
             ...
             * @return
             */
            getBoundEvents(): JavaMap<java.lang.Thread, EventContainer>;
           ...
           * @since 1.4.0
           */
          const EventContainer: JavaClassStatics<EventContainer, EventContainer$$constructor>;
          interface EventContainer$$constructor extends SuppressProperties {

            new <T extends BaseScriptContext>(ctx: T): EventContainer<T>;

          }
          interface EventContainer<T extends BaseScriptContext> extends java.lang.Object {
          ...
          const BaseWrappedException: JavaClassStatics<BaseWrappedException, BaseWrappedException$$constructor> & {

            wrapHostElement(t: java.lang.StackTraceElement, next: BaseWrappedException): BaseWrappedException<java.lang.StackTraceElement>;

          }
          interface BaseWrappedException$$constructor extends SuppressProperties {

            new <T>(exception: T, message: string, location: BaseWrappedException$SourceLocation, next: BaseWrappedException): BaseWrappedException<T>;

          }
          interface BaseWrappedException<T> extends java.lang.Object {
            readonly stackFrame: T;
            readonly location: BaseWrappedException$SourceLocation;
            readonly message: string;
            readonly next: BaseWrappedException;
          }
           ...
           * @since 1.1.3
           */
          const BaseLanguage: JavaClassStatics<BaseLanguage, BaseLanguage$$constructor>;
          interface BaseLanguage$$constructor extends SuppressProperties {

            new <U, T extends BaseScriptContext<U>>(extension: Extension, runner: Core): BaseLanguage<U, T>;

          }
          interface BaseLanguage<U, T extends BaseScriptContext<U>> extends java.lang.Object {
            readonly extension: Extension;
            preThread: java.lang.Runnable;

            trigger(macro: ScriptTrigger, event: Events.BaseEvent, then: java.lang.Runnable, catcher: java.util.function.Consumer<java.lang.Throwable>): EventContainer<T>;
          ...
          interface BaseWrappedException$SourceLocation extends java.lang.Object {}
        ...
        namespace library {
          ...
          interface BaseLibrary extends java.lang.Object {}
          ...
          interface LibraryRegistry extends java.lang.Object {
            ...
            getLibraries(language: BaseLanguage, context: BaseScriptContext): JavaMap<string, BaseLibrary>;
            getOnceLibraries(language: BaseLanguage): JavaMap<string, BaseLibrary>;
            getPerExecLibraries(language: BaseLanguage, context: BaseScriptContext): JavaMap<string, BaseLibrary>;
          ...
          export { BaseLibrary, LibraryRegistry, Library, PerLanguageLibrary }
        ...
        namespace library {
          ...
          namespace impl {
            ...
            interface FJsMacros$EventAndContext$$constructor extends SuppressProperties {
              ...
              new (event: Events.BaseEvent, context: EventContainer): FJsMacros$EventAndContext;

            }
            interface FJsMacros$EventAndContext extends java.lang.Object {
              readonly event: Events.BaseEvent;
              readonly context: EventContainer;
            }
          ...
          namespace impl {
            ...
            namespace classes {
              ...
              interface HTTPRequest$Response extends java.lang.Object {
               ...
               * @since 1.6.5
               */
              const ClassBuilder: JavaClassStatics<ClassBuilder, ClassBuilder$$constructor> & {
                readonly methodWrappers: JavaMap<string, MethodWrapper>;
              }
              ...
              interface ClassBuilder<T> extends java.lang.Object {
               ...
               * @since 1.6.0
               */
              const ProxyBuilder: JavaClassStatics<ProxyBuilder, ProxyBuilder$$constructor>;
              ...
              interface ProxyBuilder<T> extends java.lang.Object {
                readonly factory: javassist.util.proxy.ProxyFactory;
                readonly proxiedMethods: JavaMap<ProxyBuilder$MethodSigParts, MethodWrapper<ProxyBuilder$ProxyReference<T>, JavaArray<any>>>;
                readonly proxiedMethodDefaults: JavaMap<string, MethodWrapper<ProxyBuilder$ProxyReference<T>, JavaArray<any>>>;
                 ...
                 */
                addMethod(methodNameOrSig: string, proxyMethod: MethodWrapper<ProxyBuilder$ProxyReference<T>, any[]>): ProxyBuilder<T>;
              ...
              interface Websocket extends java.lang.Object {

                /**
                 * calls your method as a {@link java.util.function.Consumer}<{@link WebSocket}, {@link List}<{@link String}>>
                 */
                onConnect: MethodWrapper<com.neovisionaries.ws.client.WebSocket, JavaMap<string, JavaList<string>>>;

                /**
                 * calls your method as a {@link java.util.function.BiConsumer}<{@link WebSocket}, {@link String}>
                 */
                onTextMessage: MethodWrapper<com.neovisionaries.ws.client.WebSocket, string>;

                /**
                 * calls your method as a {@link java.util.function.BiConsumer}<{@link WebSocket}, {@link Disconnected}>
                 */
                onDisconnect: MethodWrapper<com.neovisionaries.ws.client.WebSocket, Websocket$Disconnected>;

                /**
                 * calls your method as a {@link java.util.function.BiConsumer}<{@link WebSocket}, {@link WebSocketException}>
                 */
                onError: MethodWrapper<com.neovisionaries.ws.client.WebSocket, com.neovisionaries.ws.client.WebSocketException>;

                /**
                 * calls your method as a {@link java.util.function.BiConsumer}<{@link WebSocket}, {@link WebSocketFrame}>
                 */
                onFrame: MethodWrapper<com.neovisionaries.ws.client.WebSocket, com.neovisionaries.ws.client.WebSocketFrame>;
              ...
              interface HTTPRequest extends java.lang.Object {
              ...
              interface FileHandler extends java.lang.Object {
              ...
              interface ClassBuilder$MethodBuilder extends java.lang.Object {
                ...
                guestBody(methodBody: MethodWrapper): ClassBuilder<T>;
                buildBody(): ClassBuilder$BodyBuilder;
                body(buildBody: MethodWrapper<javassist.CtClass, javassist.CtBehavior>): ClassBuilder<T>;
              ...
              interface ProxyBuilder$MethodSigParts extends java.lang.Object {
              ...
              interface ProxyBuilder$ProxyReference<T> extends java.lang.Object {
              ...
              interface ClassBuilder$AnnotationBuilder<T> extends java.lang.Object {
                ...
                putFloat(key: string, value: float): ClassBuilder$AnnotationBuilder<T>;
              ...
              interface ClassBuilder$FieldBuilder extends java.lang.Object {
              ...
              interface Websocket$Disconnected extends java.lang.Object {
              ...
              interface ClassBuilder$FieldBuilder$FieldInitializerBuilder extends java.lang.Object {

                setInt(value: int): ClassBuilder$FieldBuilder;
                setLong(value: long): ClassBuilder$FieldBuilder;
                setFloat(value: float): ClassBuilder$FieldBuilder;
              ...
              interface ClassBuilder$BodyBuilder extends java.lang.Object {
                 ...
                 * @return
                 */
                appendGuestCode(code: MethodWrapper, argsAsObjects: string, tokenBefore: string): ClassBuilder$BodyBuilder;
              ...
              interface ClassBuilder$AnnotationBuilder$AnnotationArrayBuilder<U> extends java.lang.Object {
                ...
                putFloat(value: float): ClassBuilder$AnnotationBuilder$AnnotationArrayBuilder<U>;
        ...
        namespace config {
          ...
          interface BaseProfile extends java.lang.Object {
          ...
          interface ConfigManager extends java.lang.Object {
          ...
          interface ScriptTrigger extends java.lang.Object {
        ...
        namespace service {
          ...
          interface ServiceManager$$constructor extends SuppressProperties {
            ...
            new (runner: Core): ServiceManager;

          }
          interface ServiceManager extends java.lang.Object {
          ...
          interface ServiceTrigger extends java.lang.Object {
            file: string;
            enabled: boolean;
          ...
          interface EventService extends java.lang.Object, Events.BaseEvent {
            readonly serviceName: string;
        ...
        namespace event {
          ...
          interface IEventListener extends JavaObject {
            ...
            trigger(event: Events.BaseEvent): EventContainer;
          ...
          interface BaseEventRegistry extends java.lang.Object {
        ...
        namespace event {
          ...
          namespace impl {
            ...
            interface EventCustom extends java.lang.Object, Events.BaseEvent {
              eventName: string;
        ...
        namespace classes {
          ...
          interface Mappings extends java.lang.Object {
           ...
           */
          const WrappedClassInstance: JavaClassStatics<WrappedClassInstance, WrappedClassInstance$$constructor>;
          ...
          interface WrappedClassInstance<T> extends java.lang.Object {
          ...
          interface Mappings$ClassData extends java.lang.Object {
          ...
          interface Mappings$MethodData extends java.lang.Object {
            readonly name: string;
        ...
        namespace helpers {
          ...
          const BaseHelper: JavaClassStatics<BaseHelper, BaseHelper$$constructor>;
          interface BaseHelper$$constructor extends SuppressProperties {

            new <T>(base: T): BaseHelper<T>;

          }
          interface BaseHelper<T> extends java.lang.Object {
        ...
        namespace extensions {
          ...
          interface ExtensionLoader$$constructor extends SuppressProperties {
            ...
            new (core: Core): ExtensionLoader;

          }
          interface ExtensionLoader extends java.lang.Object {
          ...
          interface Extension extends JavaObject {
             ...
             */
            getLanguage(runner: Core): BaseLanguage;
            getLibraries(): JavaSet<JavaClass<any>>;
            getDependencies(): JavaSet<java.net.URL>;
            wrapException(t: java.lang.Throwable): BaseWrappedException;
        ...
        namespace api {
          ...
          namespace helpers {
            ...
            interface PlayerListEntryHelper$$constructor extends SuppressProperties {
              ...
              new (p: /* net.minecraft.client.network.PlayerListEntry */ any): PlayerListEntryHelper;

            }
            interface PlayerListEntryHelper extends BaseHelper</* net.minecraft.client.network.PlayerListEntry */ any> {
            ...
            interface BlockPosHelper$$constructor extends SuppressProperties {
              ...
              new (b: /* net.minecraft.util.math.BlockPos */ any): BlockPosHelper;
              new (x: int, y: int, z: int): BlockPosHelper;

            }
            interface BlockPosHelper extends BaseHelper</* net.minecraft.util.math.BlockPos */ any> {
             ...
             * @since 1.0.3
             */
            const ClientPlayerEntityHelper: JavaClassStatics<ClientPlayerEntityHelper, ClientPlayerEntityHelper$$constructor>;
            interface ClientPlayerEntityHelper$$constructor extends SuppressProperties {

              new <T extends /* net.minecraft.client.network.ClientPlayerEntity */ any>(e: T): ClientPlayerEntityHelper<T>;

            }
            interface ClientPlayerEntityHelper<T = /* net.minecraft.client.network.ClientPlayerEntity */ any> extends PlayerEntityHelper<T> {
               ...
               * @param entity
               */
              attack(entity: EntityHelper, await: boolean): ClientPlayerEntityHelper<T>;
               ...
               */
              interactEntity(entity: EntityHelper, offHand: boolean): ClientPlayerEntityHelper<T>;
               ...
               * @throws InterruptedException
               */
              interactEntity(entity: EntityHelper, offHand: boolean, await: boolean): ClientPlayerEntityHelper<T>;
            ...
            interface StatsHelper$$constructor extends SuppressProperties {
              ...
              new (base: /* net.minecraft.stat.StatHandler */ any): StatsHelper;

            }
            interface StatsHelper extends BaseHelper</* net.minecraft.stat.StatHandler */ any> {
            ...
            interface BossBarHelper$$constructor extends SuppressProperties {
              ...
              new (b: /* net.minecraft.entity.boss.BossBar */ any): BossBarHelper;

            }
            interface BossBarHelper extends BaseHelper</* net.minecraft.entity.boss.BossBar */ any> {
            ...
            interface CommandContextHelper extends BaseHelper<com.mojang.brigadier.context.CommandContext<any>>, Events.BaseEvent {
            ...
            interface CommandNodeHelper extends BaseHelper<com.mojang.brigadier.tree.CommandNode<any>> {
            ...
            interface TextHelper$$constructor extends SuppressProperties {
              ...
              new (t: /* net.minecraft.text.Text */ any): TextHelper;

            }
            interface TextHelper extends BaseHelper</* net.minecraft.text.Text */ any> {
               ...
               * @since 1.6.5
               */
              visit(visitor: MethodWrapper<StyleHelper, string>): void;
            ...
            interface ServerInfoHelper$$constructor extends SuppressProperties {
              ...
              new (base: /* net.minecraft.client.network.ServerInfo */ any): ServerInfoHelper;

            }
            interface ServerInfoHelper extends BaseHelper</* net.minecraft.client.network.ServerInfo */ any> {
            ...
            interface BlockHelper$$constructor extends SuppressProperties {
              ...
              new (base: /* net.minecraft.block.Block */ any): BlockHelper;

            }
            interface BlockHelper extends BaseHelper</* net.minecraft.block.Block */ any> {
             ...
             * @author Wagyourtail
             */
            const EntityHelper: JavaClassStatics<EntityHelper> & NoConstructor & {
               ...
               */
              create(e: /* net.minecraft.entity.Entity */ any): EntityHelper;

            }
            interface EntityHelper<T = /* net.minecraft.entity.Entity */ any> extends BaseHelper<T> {
               ...
               * @param color
               */
              setGlowingColor(color: int): void;
            ...
            interface OptionsHelper$$constructor extends SuppressProperties {
              ...
              new (options: /* net.minecraft.client.option.GameOptions */ any): OptionsHelper;

            }
            interface OptionsHelper extends BaseHelper</* net.minecraft.client.option.GameOptions */ any> {
               ...
               * @param volume
               */
              setVolume(category: string, volume: double): void;
            ...
            interface ItemStackHelper$$constructor extends SuppressProperties {
              ...
              new (i: /* net.minecraft.item.ItemStack */ any): ItemStackHelper;

            }
            interface ItemStackHelper extends BaseHelper</* net.minecraft.item.ItemStack */ any> {
             ...
             * @author Wagyourtail
             */
            const PlayerEntityHelper: JavaClassStatics<PlayerEntityHelper, PlayerEntityHelper$$constructor>;
            interface PlayerEntityHelper$$constructor extends SuppressProperties {

              new <T extends /* net.minecraft.entity.player.PlayerEntity */ any>(e: T): PlayerEntityHelper<T>;

            }
            interface PlayerEntityHelper<T = /* net.minecraft.entity.player.PlayerEntity */ any> extends LivingEntityHelper<T> {
            ...
            interface ScoreboardsHelper$$constructor extends SuppressProperties {
              ...
              new (board: /* net.minecraft.scoreboard.Scoreboard */ any): ScoreboardsHelper;

            }
            interface ScoreboardsHelper extends BaseHelper</* net.minecraft.scoreboard.Scoreboard */ any> {
               ...
               * @return
               */
              getObjectiveForTeamColorIndex(index: int): ScoreboardObjectiveHelper;
               ...
               * @return
               */
              getObjectiveSlot(slot: int): ScoreboardObjectiveHelper;
               ...
               * @return
               */
              getPlayerTeamColorIndex(entity: PlayerEntityHelper</* net.minecraft.entity.player.PlayerEntity */ any>): number;
               ...
               * @return
               */
              getPlayerTeam(p: PlayerEntityHelper</* net.minecraft.entity.player.PlayerEntity */ any>): TeamHelper;
            ...
            interface BlockDataHelper$$constructor extends SuppressProperties {
              ...
              new (b: /* net.minecraft.block.BlockState */ any, e: /* net.minecraft.block.entity.BlockEntity */ any, bp: /* net.minecraft.util.math.BlockPos */ any): BlockDataHelper;

            }
            interface BlockDataHelper extends BaseHelper</* net.minecraft.block.BlockState */ any> {
            ...
            interface BlockStateHelper$$constructor extends SuppressProperties {
              ...
              new (base: /* net.minecraft.block.BlockState */ any): BlockStateHelper;

            }
            interface BlockStateHelper extends BaseHelper</* net.minecraft.block.BlockState */ any> {
              ...
              /**
               * @return `true` if the state blocks light.
               * @since 1.6.5
               */
              blocksLight(): boolean;
               ...
               * @param pos
               * @param entity
               * @return `true` if the entity can spawn on this block state at the given position in the current world.
               * @since 1.6.5
               */
              ...
              /**
               * @param pos
               * @return `true` if an entity can suffocate in this block state at the given position in the current world.
               * @since 1.6.5
               */
            ...
            interface VillagerEntityHelper$$constructor extends SuppressProperties {
              ...
              new (e: /* net.minecraft.entity.passive.VillagerEntity */ any): VillagerEntityHelper;

            }
            interface VillagerEntityHelper extends MerchantEntityHelper</* net.minecraft.entity.passive.VillagerEntity */ any> {
            ...
            interface TeamHelper$$constructor extends SuppressProperties {
              ...
              new (t: /* net.minecraft.scoreboard.Team */ any): TeamHelper;

            }
            interface TeamHelper extends BaseHelper</* net.minecraft.scoreboard.Team */ any> {
            ...
            interface StyleHelper$$constructor extends SuppressProperties {
              ...
              new (base: /* net.minecraft.text.Style */ any): StyleHelper;

            }
            interface StyleHelper extends BaseHelper</* net.minecraft.text.Style */ any> {
            ...
            const MerchantEntityHelper: JavaClassStatics<MerchantEntityHelper, MerchantEntityHelper$$constructor>;
            interface MerchantEntityHelper$$constructor extends SuppressProperties {

              new <T extends /* net.minecraft.entity.passive.MerchantEntity */ any>(e: T): MerchantEntityHelper<T>;

            }
            interface MerchantEntityHelper<T = /* net.minecraft.entity.passive.MerchantEntity */ any> extends LivingEntityHelper<T> {
            ...
            /** @since 1.5.1 */
            const NBTElementHelper: JavaClassStatics<NBTElementHelper> & NoConstructor & {

              /** @since 1.5.1 */
              resolve(element: /* net.minecraft.nbt.NbtElement */ any): NBTElementHelper;

            }
            interface NBTElementHelper<T = /* net.minecraft.nbt.NbtElement */ any> extends BaseHelper<T> {
            ...
            interface ScoreboardObjectiveHelper$$constructor extends SuppressProperties {
              ...
              new (o: /* net.minecraft.scoreboard.ScoreboardObjective */ any): ScoreboardObjectiveHelper;

            }
            interface ScoreboardObjectiveHelper extends BaseHelper</* net.minecraft.scoreboard.ScoreboardObjective */ any> {
            ...
            interface ItemEntityHelper$$constructor extends SuppressProperties {
              ...
              new (e: /* net.minecraft.entity.ItemEntity */ any): ItemEntityHelper;

            }
            interface ItemEntityHelper extends EntityHelper</* net.minecraft.entity.ItemEntity */ any> {

              getContainedItemStack(): ItemStackHelper;

            }

            const LivingEntityHelper: JavaClassStatics<LivingEntityHelper, LivingEntityHelper$$constructor>;
            interface LivingEntityHelper$$constructor extends SuppressProperties {

              new <T extends /* net.minecraft.entity.LivingEntity */ any>(e: T): LivingEntityHelper<T>;

            }
            interface LivingEntityHelper<T = /* net.minecraft.entity.LivingEntity */ any> extends EntityHelper<T> {
            ...
            interface PlayerAbilitiesHelper$$constructor extends SuppressProperties {
              ...
              new (a: /* net.minecraft.entity.player.PlayerAbilities */ any): PlayerAbilitiesHelper;

            }
            interface PlayerAbilitiesHelper extends BaseHelper</* net.minecraft.entity.player.PlayerAbilities */ any> {
            ...
            interface NBTElementHelper$NBTNumberHelper extends NBTElementHelper</* net.minecraft.nbt.AbstractNbtNumber */ any> {
            ...
            interface NBTElementHelper$NBTListHelper extends NBTElementHelper</* net.minecraft.nbt.AbstractNbtList<any> */ any> {
              ...
              length(): number;
              /** @since 1.5.1 */
              get(index: int): NBTElementHelper;
              /** @since 1.5.1 */
              getHeldType(): number;
            ...
            interface StatusEffectHelper$$constructor extends SuppressProperties {
              ...
              new (s: /* net.minecraft.entity.effect.StatusEffectInstance */ any): StatusEffectHelper;

            }
            interface StatusEffectHelper extends BaseHelper</* net.minecraft.entity.effect.StatusEffectInstance */ any> {
            ...
            interface TradeOfferHelper$$constructor extends SuppressProperties {
              ...
              new (base: /* net.minecraft.village.TradeOffer */ any, index: int, inv: VillagerInventory): TradeOfferHelper;

            }
            interface TradeOfferHelper extends BaseHelper</* net.minecraft.village.TradeOffer */ any> {
            ...
            interface NBTElementHelper$NBTCompoundHelper extends NBTElementHelper</* net.minecraft.nbt.NbtCompound */ any> {
            ...
            interface TextFieldWidgetHelper$$constructor extends SuppressProperties {
              ...
              new (t: /* net.minecraft.client.gui.widget.TextFieldWidget */ any): TextFieldWidgetHelper;
              new (t: /* net.minecraft.client.gui.widget.TextFieldWidget */ any, zIndex: int): TextFieldWidgetHelper;

            }
            interface TextFieldWidgetHelper extends ButtonWidgetHelper</* net.minecraft.client.gui.widget.TextFieldWidget */ any> {
            ...
            interface ChatHudLineHelper$$constructor extends SuppressProperties {
              ...
              new (base: /* net.minecraft.client.gui.hud.ChatHudLine */ any, hud: /* net.minecraft.client.gui.hud.ChatHud */ any): ChatHudLineHelper;

            }
            interface ChatHudLineHelper extends BaseHelper</* net.minecraft.client.gui.hud.ChatHudLine */ any> {
             ...
             * @since 1.0.5
             */
            const ButtonWidgetHelper: JavaClassStatics<ButtonWidgetHelper, ButtonWidgetHelper$$constructor>;
            interface ButtonWidgetHelper$$constructor extends SuppressProperties {

              new <T extends /* net.minecraft.client.gui.widget.ClickableWidget */ any>(btn: T): ButtonWidgetHelper<T>;
              new <T extends /* net.minecraft.client.gui.widget.ClickableWidget */ any>(btn: T, zIndex: int): ButtonWidgetHelper<T>;

            }
            interface ButtonWidgetHelper<T = /* net.minecraft.client.gui.widget.ClickableWidget */ any> extends BaseHelper<T>, RenderCommon$RenderElement {
              zIndex: number;
               ...
               * @return
               */
              setPos(x: int, y: int): ButtonWidgetHelper<T>;
               ...
               * @return
               */
              setWidth(width: int): ButtonWidgetHelper<T>;
             ...
             * @since 1.3.1
             */
            const RecipeHelper: JavaClassStatics<RecipeHelper, RecipeHelper$$constructor>;
            interface RecipeHelper$$constructor extends SuppressProperties {

              new (base: /* net.minecraft.recipe.Recipe<any> */ any, syncId: int): RecipeHelper;

            }
            interface RecipeHelper extends BaseHelper</* net.minecraft.recipe.Recipe<any> */ any> {
            ...
            interface SuggestionsBuilderHelper extends BaseHelper<com.mojang.brigadier.suggestion.SuggestionsBuilder> {
          ...
          namespace classes {
            ...
            interface ChatHistoryManager$$constructor extends SuppressProperties {
              ...
              new (hud: /* net.minecraft.client.gui.hud.ChatHud */ any): ChatHistoryManager;

            }
            interface ChatHistoryManager extends java.lang.Object {
               ...
               * @return
               */
              getRecvLine(index: int): ChatHudLineHelper;
               ...
               * @param line
               */
              insertRecvText(index: int, line: TextHelper): void;
               ...
               * @since 1.6.0
               */
              insertRecvText(index: int, line: TextHelper, timeTicks: int): void;
               ...
               * @throws InterruptedException
               */
              insertRecvText(index: int, line: TextHelper, timeTicks: int, await: boolean): void;
               ...
               * @param filter
               */
              removeRecvTextMatchingFilter(filter: MethodWrapper<ChatHudLineHelper, any, boolean>): void;
               ...
               * @throws InterruptedException
               */
              removeRecvTextMatchingFilter(filter: MethodWrapper<ChatHudLineHelper, any, boolean>, await: boolean): void;
            ...
            interface TextBuilder extends java.lang.Object {
               ...
               * @return
               */
              withShowEntityHover(entity: EntityHelper</* net.minecraft.entity.Entity */ any>): TextBuilder;
               ...
               * @return
               */
              withCustomClickEvent(action: MethodWrapper): TextBuilder;
            ...
            interface Draw2D extends /* net.minecraft.client.gui.DrawableHelper */ JavaObject, IDraw2D<Draw2D> {

              /**
               * @since 1.0.5
               * @deprecated please use {@link Draw2D#setOnInit(MethodWrapper)}
               */
              onInit: MethodWrapper<Draw2D>;

              /**
               * @since 1.1.9 [citation needed]
               * @deprecated please use {@link Draw2D#setOnFailInit(MethodWrapper)}
               */
              catchInit: MethodWrapper<string>;
              ...
              reAddElement(e: RenderCommon$RenderElement): RenderCommon$RenderElement;

              /**
               * @since 1.0.5
               * @see IDraw2D#addText(String, int, int, int, boolean)
               */
              addText(text: string, x: int, y: int, color: int, shadow: boolean): RenderCommon$Text;
              addText(text: string, x: int, y: int, color: int, zIndex: int, shadow: boolean): RenderCommon$Text;

              /**
               * @since 1.2.6
               * @see IDraw2D#addText(String, int, int, int, boolean, double, double)
               */
              addText(text: string, x: int, y: int, color: int, shadow: boolean, scale: double, rotation: double): RenderCommon$Text;
              addText(text: string, x: int, y: int, color: int, zIndex: int, shadow: boolean, scale: double, rotation: double): RenderCommon$Text;
              addText(text: TextHelper, x: int, y: int, color: int, shadow: boolean): RenderCommon$Text;
              addText(text: TextHelper, x: int, y: int, color: int, zIndex: int, shadow: boolean): RenderCommon$Text;
              addText(text: TextHelper, x: int, y: int, color: int, shadow: boolean, scale: double, rotation: double): RenderCommon$Text;
              addText(text: TextHelper, x: int, y: int, color: int, zIndex: int, shadow: boolean, scale: double, rotation: double): RenderCommon$Text;

              /**
               * @since 1.0.5
               * @see IDraw2D#removeText(RenderCommon.Text)
               */
               ...
               */
              addImage(x: int, y: int, width: int, height: int, id: string, imageX: int, imageY: int, regionWidth: int, regionHeight: int, textureWidth: int, textureHeight: int): RenderCommon$Image;
              addImage(x: int, y: int, width: int, height: int, zIndex: int, id: string, imageX: int, imageY: int, regionWidth: int, regionHeight: int, textureWidth: int, textureHeight: int): RenderCommon$Image;

              /**
               * @since 1.2.6
               * @see IDraw2D#addImage(int, int, int, int, String, int, int, int, int, int, int, double)
               */
              addImage(x: int, y: int, width: int, height: int, id: string, imageX: int, imageY: int, regionWidth: int, regionHeight: int, textureWidth: int, textureHeight: int, rotation: double): RenderCommon$Image;

              /**
               * @since 1.4.0
               * @see IDraw2D#addImage(int, int, int, int, int, String, int, int, int, int, int, int, double)
               */
              addImage(x: int, y: int, width: int, height: int, zIndex: int, id: string, imageX: int, imageY: int, regionWidth: int, regionHeight: int, textureWidth: int, textureHeight: int, rotation: double): RenderCommon$Image;

              /**
               * @since 1.6.5
               * @see IDraw2D#addImage(int, int, int, int, int, int, String, int, int, int, int, int, int, double)
               */
              addImage(x: int, y: int, width: int, height: int, zIndex: int, color: int, id: string, imageX: int, imageY: int, regionWidth: int, regionHeight: int, textureWidth: int, textureHeight: int, rotation: double): RenderCommon$Image;

              /**
               * @since 1.6.5
               * @see IDraw2D#addImage(int, int, int, int, int, int, int, String, int, int, int, int, int, int, double)
               */
              addImage(x: int, y: int, width: int, height: int, zIndex: int, alpha: int, color: int, id: string, imageX: int, imageY: int, regionWidth: int, regionHeight: int, textureWidth: int, textureHeight: int, rotation: double): RenderCommon$Image;

              /**
               * @since 1.2.3
               * @see IDraw2D#removeImage(RenderCommon.Image)
               */
               ...
               */
              addRect(x1: int, y1: int, x2: int, y2: int, color: int): RenderCommon$Rect;

              /**
               * @since 1.1.8
               * @see IDraw2D#addRect(int, int, int, int, int, int)
               */
              addRect(x1: int, y1: int, x2: int, y2: int, color: int, alpha: int): RenderCommon$Rect;

              /**
               * @since 1.2.6
               * @see IDraw2D#addRect(int, int, int, int, int, int, double)
               */
              addRect(x1: int, y1: int, x2: int, y2: int, color: int, alpha: int, rotation: double): RenderCommon$Rect;
              addRect(x1: int, y1: int, x2: int, y2: int, color: int, alpha: int, rotation: double, zIndex: int): RenderCommon$Rect;

              /**
               * @since 1.0.5
               * @see IDraw2D#removeRect(RenderCommon.Rect)
               */
               ...
               */
              addItem(x: int, y: int, id: ItemId): RenderCommon$Item;
              addItem(x: int, y: int, zIndex: int, id: ItemId): RenderCommon$Item;

              /**
               * @since 1.2.0
               * @see IDraw2D#addItem(int, int, String, boolean)
               */
              addItem(x: int, y: int, id: ItemId, overlay: boolean): RenderCommon$Item;
              addItem(x: int, y: int, zIndex: int, id: ItemId, overlay: boolean): RenderCommon$Item;

              /**
               * @since 1.2.0
               * @see IDraw2D#addItem(int, int, String, boolean, double, double)
               */
              addItem(x: int, y: int, id: ItemId, overlay: boolean, scale: double, rotation: double): RenderCommon$Item;
              addItem(x: int, y: int, zIndex: int, id: ItemId, overlay: boolean, scale: double, rotation: double): RenderCommon$Item;

              /**
               * @since 1.0.5
               * @see IDraw2D#addItem(int, int, ItemStackHelper)
               */
              addItem(x: int, y: int, Item: ItemStackHelper): RenderCommon$Item;
              addItem(x: int, y: int, zIndex: int, item: ItemStackHelper): RenderCommon$Item;

              /**
               * @since 1.2.0
               * @see IDraw2D#addItem(int, int, ItemStackHelper, boolean)
               */
              addItem(x: int, y: int, Item: ItemStackHelper, overlay: boolean): RenderCommon$Item;
              addItem(x: int, y: int, zIndex: int, item: ItemStackHelper, overlay: boolean): RenderCommon$Item;

              /**
               * @since 1.2.6
               * @see IDraw2D#addItem(int, int, ItemStackHelper, boolean, double, double)
               */
              addItem(x: int, y: int, item: ItemStackHelper, overlay: boolean, scale: double, rotation: double): RenderCommon$Item;
              addItem(x: int, y: int, zIndex: int, item: ItemStackHelper, overlay: boolean, scale: double, rotation: double): RenderCommon$Item;

              /**
               * @since 1.0.5
               * @see IDraw2D#removeItem(RenderCommon.Item)
               */
              removeItem(i: RenderCommon$Item): Draw2D;
              init(): void;
              render(matrixStack: /* net.minecraft.client.util.math.MatrixStack */ any): void;
               ...
               */
              setOnInit(onInit: MethodWrapper<Draw2D>): Draw2D;
               ...
               */
              setOnFailInit(catchInit: MethodWrapper<string>): Draw2D;
            ...
            interface ScriptScreen extends BaseScreen {
               ...
               * @since 1.4.0
               */
              setOnRender(onRender: MethodWrapper<PositionCommon$Pos3D, /* net.minecraft.client.util.math.MatrixStack */ any>): void;

            }

            /** @since 1.3.1 */
            const VillagerInventory: JavaClassStatics<VillagerInventory> & NoConstructor;
            interface VillagerInventory extends Inventory</* net.minecraft.client.gui.screen.ingame.MerchantScreen */ any> {
            ...
            interface PlayerInput$$constructor extends SuppressProperties {
               ...
               * @since 1.4.0
               */
              new (input: /* net.minecraft.client.input.Input */ any, yaw: float, pitch: float, sprinting: boolean): PlayerInput;
            ...
            interface PlayerInput extends java.lang.Object {
            ...
            interface Draw3D extends java.lang.Object {
               ...
               * @since 1.0.6
               */
              addBox(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, fillColor: int, fill: boolean): Draw3D$Box;
               ...
               * @since 1.3.1
               */
              addBox(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, fillColor: int, fill: boolean, cull: boolean): Draw3D$Box;
               ...
               * @since 1.1.8
               */
              addBox(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, alpha: int, fillColor: int, fillAlpha: int, fill: boolean): Draw3D$Box;
              addBox(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, alpha: int, fillColor: int, fillAlpha: int, fill: boolean, cull: boolean): Draw3D$Box;
               ...
               * @since 1.0.6
               */
              addLine(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int): Draw3D$Line;
               ...
               * @since 1.3.1
               */
              addLine(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, cull: boolean): Draw3D$Line;
               ...
               * @since 1.1.8
               */
              addLine(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, alpha: int): Draw3D$Line;
               ...
               * @since 1.3.1
               */
              addLine(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, alpha: int, cull: boolean): Draw3D$Line;
               ...
               * @since 1.4.0
               */
              addPoint(point: PositionCommon$Pos3D, radius: double, color: int): Draw3D$Box;
               ...
               * @since 1.4.0
               */
              addPoint(x: double, y: double, z: double, radius: double, color: int): Draw3D$Box;
               ...
               * @since 1.4.0
               */
              addPoint(x: double, y: double, z: double, radius: double, color: int, alpha: int, cull: boolean): Draw3D$Box;
               ...
               * @return
               */
              addDraw2D(x: double, y: double, z: double): Draw3D$Surface;
               ...
               * @return
               */
              addDraw2D(x: double, y: double, z: double, width: double, height: double): Draw3D$Surface;
               ...
               * @return
               */
              addDraw2D(x: double, y: double, z: double, xRot: double, yRot: double, zRot: double): Draw3D$Surface;
               ...
               * @return
               */
              addDraw2D(x: double, y: double, z: double, xRot: double, yRot: double, zRot: double, width: double, height: double): Draw3D$Surface;
               ...
               * @return
               */
              addDraw2D(x: double, y: double, z: double, xRot: double, yRot: double, zRot: double, width: double, height: double, minSubdivisions: int): Draw3D$Surface;
               ...
               * @return
               */
              addDraw2D(x: double, y: double, z: double, xRot: double, yRot: double, zRot: double, width: double, height: double, minSubdivisions: int, renderBack: boolean): Draw3D$Surface;
               ...
               * @return
               */
              addDraw2D(x: double, y: double, z: double, xRot: double, yRot: double, zRot: double, width: double, height: double, minSubdivisions: int, renderBack: boolean, cull: boolean): Draw3D$Surface;
              /** @since 1.6.5 */
            ...
            interface CommandBuilder extends java.lang.Object {
               ...
               * @return
               */
              executes(callback: MethodWrapper<CommandContextHelper>): CommandBuilder;
               ...
               * @return
               */
              suggest(callback: MethodWrapper<CommandContextHelper, SuggestionsBuilderHelper>): CommandBuilder;
              or(): CommandBuilder;
             ...
             * @since 1.0.8
             */
            const Inventory: JavaClassStatics<Inventory> & NoConstructor & {

              create(): Inventory;
              create(s: /* net.minecraft.client.gui.screen.Screen */ any): Inventory;

            }
            interface Inventory<T = /* net.minecraft.client.gui.screen.ingame.HandledScreen<any> */ any> extends java.lang.Object {
               ...
               */
              quickAll(slot: int, button: int): number;
               ...
               */
              getSlot(slot: int): ItemStackHelper;
               ...
               * @return
               */
              swapHotbar(slot: int, hotbarSlot: HotbarSlot | OffhandSlot): Inventory<T>;
              /** @since 1.2.8 */
              openGui(): void;
            ...
            interface CommandManager extends java.lang.Object {
               ...
               * @param commandPart
               */
              getArgumentAutocompleteOptions(commandPart: string, callback: MethodWrapper<JavaList<string>>): void;

            }

            const Draw3D$Box: JavaClassStatics<Draw3D$Box, Draw3D$Box$$constructor>;
            interface Draw3D$Box$$constructor extends SuppressProperties {

              new (x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, fillColor: int, fill: boolean, cull: boolean): Draw3D$Box;
              new (x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, alpha: int, fillColor: int, fillAlpha: int, fill: boolean, cull: boolean): Draw3D$Box;

            }
            interface Draw3D$Box extends java.lang.Object {
            ...
            /** @since 1.6.5 */
            const Draw3D$Surface: JavaClassStatics<Draw3D$Surface, Draw3D$Surface$$constructor>;
            interface Draw3D$Surface$$constructor extends SuppressProperties {

              new (pos: PositionCommon$Pos3D, rotations: PositionCommon$Pos3D, sizes: PositionCommon$Pos2D, minSubdivisions: int, renderBack: boolean, cull: boolean): Draw3D$Surface;
            ...
            interface Draw3D$Surface extends Draw2D {
              ...
              getWidth(): number;
              init(): void;
              render3D(matrixStack: /* net.minecraft.client.util.math.MatrixStack */ any): void;
              render(matrixStack: /* net.minecraft.client.util.math.MatrixStack */ any): void;

            }

            const Draw3D$Line: JavaClassStatics<Draw3D$Line, Draw3D$Line$$constructor>;
            interface Draw3D$Line$$constructor extends SuppressProperties {

              new (x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, cull: boolean): Draw3D$Line;
              new (x1: double, y1: double, z1: double, x2: double, y2: double, z2: double, color: int, alpha: int, cull: boolean): Draw3D$Line;

            }
            interface Draw3D$Line extends java.lang.Object {
              pos: PositionCommon$Vec3D;
              color: number;
              cull: boolean;
          ...
          namespace classes {
            ...
            namespace worldscanner {
              ...
              interface WorldScanner$$constructor extends SuppressProperties {
                 ...
                 * @param stateFilter
                 */
                new (world: /* net.minecraft.world.World */ any, blockFilter: java.util.function.Function<BlockHelper, boolean>, stateFilter: java.util.function.Function<BlockStateHelper, boolean>): WorldScanner;

              }
              interface WorldScanner extends java.lang.Object {
                 ...
                 * @return
                 */
                scanAroundPlayer(range: int): JavaList<PositionCommon$Pos3D>;
                 ...
                 * @return the list
                 */
                scanChunkRange(centerX: int, centerZ: int, chunkrange: int): JavaList<PositionCommon$Pos3D>;
              ...
              interface WorldScannerBuilder extends java.lang.Object {
          ...
          namespace sharedinterfaces {
            ...
            interface IScreen extends IDraw2D<IScreen> {
               ...
               * @return
               */
              addButton(x: int, y: int, width: int, height: int, text: string, callback: MethodWrapper<ButtonWidgetHelper, IScreen>): ButtonWidgetHelper;
               ...
               * @return
               */
              addButton(x: int, y: int, width: int, height: int, zIndex: int, text: string, callback: MethodWrapper<ButtonWidgetHelper, IScreen>): ButtonWidgetHelper;
               ...
               * @return
               */
              addTextInput(x: int, y: int, width: int, height: int, message: string, onChange: MethodWrapper<string, IScreen>): TextFieldWidgetHelper;
               ...
               * @return
               */
              addTextInput(x: int, y: int, width: int, height: int, zIndex: int, message: string, onChange: MethodWrapper<string, IScreen>): TextFieldWidgetHelper;
               ...
               * @return
               */
              setOnMouseDown(onMouseDown: MethodWrapper<PositionCommon$Pos2D, int>): IScreen;
               ...
               * @return
               */
              setOnMouseDrag(onMouseDrag: MethodWrapper<PositionCommon$Vec2D, int>): IScreen;
               ...
               * @return
               */
              setOnMouseUp(onMouseUp: MethodWrapper<PositionCommon$Pos2D, int>): IScreen;
               ...
               * @return
               */
              setOnScroll(onScroll: MethodWrapper<PositionCommon$Pos2D, double>): IScreen;
               ...
               * @return
               */
              setOnKeyPressed(onKeyPressed: MethodWrapper<int, int>): IScreen;
               ...
               * @return
               */
              setOnClose(onClose: MethodWrapper<IScreen>): IScreen;
              /** @since 1.1.9 */
              close(): void;
              /** @since 1.2.0 */
              addRect(x1: int, y1: int, x2: int, y2: int, color: int): RenderCommon$Rect;
               ...
               * @return added item
               */
              addItem(x: int, y: int, zIndex: int, id: string): RenderCommon$Item;
               ...
               * @return added item
               */
              addItem(x: int, y: int, zIndex: int, id: string, overlay: boolean): RenderCommon$Item;
               ...
               * @return added item
               */
              addItem(x: int, y: int, zIndex: int, id: string, overlay: boolean, scale: double, rotation: double): RenderCommon$Item;
               ...
               * @since 1.4.1
               */
              onRenderInternal(matrices: /* net.minecraft.client.util.math.MatrixStack */ any, mouseX: int, mouseY: int, delta: float): void;
              getOnClose(): MethodWrapper<IScreen>;
             ...
             * @since 1.2.7
             */
            const IDraw2D: JavaInterfaceStatics<IDraw2D>;
            interface IDraw2D<T> extends JavaObject {
               ...
               * @return added item
               */
              addItem(x: int, y: int, id: string): RenderCommon$Item;
               ...
               * @return added item
               */
              addItem(x: int, y: int, id: string, overlay: boolean): RenderCommon$Item;
               ...
               * @return added item
               */
              addItem(x: int, y: int, id: string, overlay: boolean, scale: double, rotation: double): RenderCommon$Item;
               ...
               * @return self for chaining
               */
              setOnInit(onInit: MethodWrapper<T>): T;
               ...
               * @return self for chaining
               */
              setOnFailInit(catchInit: MethodWrapper<string>): T;
          ...
          namespace sharedclasses {
             ...
             */
            const PositionCommon$Vec2D: JavaClassStatics<PositionCommon$Vec2D, PositionCommon$Vec2D$$constructor>;
            interface PositionCommon$Vec2D$$constructor extends SuppressProperties {

              new (x1: double, y1: double, x2: double, y2: double): PositionCommon$Vec2D;
              new (start: PositionCommon$Pos2D, end: PositionCommon$Pos2D): PositionCommon$Vec2D;

            }
            interface PositionCommon$Vec2D extends java.lang.Object {
              x1: number;
              y1: number;
              x2: number;
              y2: number;
               ...
               * @return
               */
              add(x1: double, y1: double, x2: double, y2: double): PositionCommon$Vec2D;
               ...
               * @return
               */
              multiply(x1: double, y1: double, x2: double, y2: double): PositionCommon$Vec2D;
               ...
               * @return
               */
              scale(scale: double): PositionCommon$Vec2D;
             ...
             * @since 1.2.6 [citation needed]
             */
            const PositionCommon$Pos2D: JavaClassStatics<PositionCommon$Pos2D, PositionCommon$Pos2D$$constructor> & {
              readonly ZERO: PositionCommon$Pos2D;
            }
            interface PositionCommon$Pos2D$$constructor extends SuppressProperties {

              new (x: double, y: double): PositionCommon$Pos2D;

            }
            interface PositionCommon$Pos2D extends java.lang.Object {
              x: number;
              y: number;
               ...
               * @return
               */
              add(x: double, y: double): PositionCommon$Pos2D;
               ...
               * @return
               */
              multiply(x: double, y: double): PositionCommon$Pos2D;
               ...
               * @return
               */
              scale(scale: double): PositionCommon$Pos2D;
               ...
               * @return
               */
              toVector(start_x: double, start_y: double): PositionCommon$Vec2D;
               ...
               * @return
               */
              toReverseVector(end_pos: PositionCommon$Pos2D): PositionCommon$Vec2D;
               ...
               * @return
               */
              toReverseVector(end_x: double, end_y: double): PositionCommon$Vec2D;
             ...
             * @since 1.2.6 [citation needed]
             */
            const PositionCommon$Vec3D: JavaClassStatics<PositionCommon$Vec3D, PositionCommon$Vec3D$$constructor>;
            interface PositionCommon$Vec3D$$constructor extends SuppressProperties {

              new (x1: double, y1: double, z1: double, x2: double, y2: double, z2: double): PositionCommon$Vec3D;
              new (start: PositionCommon$Pos3D, end: PositionCommon$Pos3D): PositionCommon$Vec3D;
            ...
            interface PositionCommon$Vec3D extends PositionCommon$Vec2D {
               ...
               * @return
               */
              addStart(x: double, y: double, z: double): PositionCommon$Vec3D;
               ...
               * @return
               */
              addEnd(x: double, y: double, z: double): PositionCommon$Vec3D;
               ...
               * @return
               */
              add(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double): PositionCommon$Vec3D;
               ...
               * @return
               */
              multiply(x1: double, y1: double, z1: double, x2: double, y2: double, z2: double): PositionCommon$Vec3D;
              multiply(vec: PositionCommon$Vec2D): PositionCommon$Vec2D;
               ...
               * @return
               */
              scale(scale: double): PositionCommon$Vec3D;
               ...
               * @return
               */
              toMojangFloatVector(): /* net.minecraft.util.math.Vec3f */ any;
             ...
             * @since 1.2.6 [citation needed]
             */
            const PositionCommon$Pos3D: JavaClassStatics<PositionCommon$Pos3D, PositionCommon$Pos3D$$constructor> & {
              readonly ZERO: PositionCommon$Pos3D;
            }
            interface PositionCommon$Pos3D$$constructor extends SuppressProperties {

              new (vec: /* net.minecraft.util.math.Vec3d */ any): PositionCommon$Pos3D;
              new (x: double, y: double, z: double): PositionCommon$Pos3D;
            ...
            interface PositionCommon$Pos3D extends PositionCommon$Pos2D {
               ...
               * @return
               */
              add(x: double, y: double, z: double): PositionCommon$Pos3D;
              add(pos: PositionCommon$Pos2D): PositionCommon$Pos2D;
               ...
               * @return
               */
              multiply(x: double, y: double, z: double): PositionCommon$Pos3D;
              multiply(pos: PositionCommon$Pos2D): PositionCommon$Pos2D;
               ...
               * @return
               */
              scale(scale: double): PositionCommon$Pos3D;
               ...
               * @return
               */
              toVector(start_x: double, start_y: double, start_z: double): PositionCommon$Vec3D;
              ...
              toReverseVector(end_pos: PositionCommon$Pos2D): PositionCommon$Vec3D;
               ...
               * @return
               */
              toReverseVector(end_pos: PositionCommon$Pos3D): PositionCommon$Vec3D;
               ...
               * @return
               */
              toReverseVector(end_x: double, end_y: double, end_z: double): PositionCommon$Vec3D;
            ...
            const RenderCommon$RenderElement: JavaInterfaceStatics<RenderCommon$RenderElement>;
            interface RenderCommon$RenderElement extends /* net.minecraft.client.gui.Drawable */ JavaObject {

              getZIndex(): number;
              render3D(matrices: /* net.minecraft.client.util.math.MatrixStack */ any, mouseX: int, mouseY: int, delta: float): void;
             ...
             * @since 1.0.5
             */
            const RenderCommon$Item: JavaClassStatics<RenderCommon$Item, RenderCommon$Item$$constructor>;
            interface RenderCommon$Item$$constructor extends SuppressProperties {

              new (x: int, y: int, zIndex: int, id: string, overlay: boolean, scale: double, rotation: float): RenderCommon$Item;
              new (x: int, y: int, zIndex: int, i: ItemStackHelper, overlay: boolean, scale: double, rotation: float): RenderCommon$Item;

            }
            interface RenderCommon$Item extends java.lang.Object, RenderCommon$RenderElement {
               ...
               * @return
               */
              setPos(x: int, y: int): RenderCommon$Item;
               ...
               * @throws Exception
               */
              setScale(scale: double): RenderCommon$Item;
               ...
               * @return
               */
              setRotation(rotation: double): RenderCommon$Item;
               ...
               * @return
               */
              setItem(id: ItemId, count: int): RenderCommon$Item;
             ...
             * @since 1.0.5
             */
            const RenderCommon$Rect: JavaClassStatics<RenderCommon$Rect, RenderCommon$Rect$$constructor>;
            interface RenderCommon$Rect$$constructor extends SuppressProperties {

              new (x1: int, y1: int, x2: int, y2: int, color: int, rotation: float, zIndex: int): RenderCommon$Rect;
              new (x1: int, y1: int, x2: int, y2: int, color: int, alpha: int, rotation: float, zIndex: int): RenderCommon$Rect;

            }
            interface RenderCommon$Rect extends java.lang.Object, RenderCommon$RenderElement {
              rotation: number;
              x1: number;
              y1: number;
              x2: number;
               ...
               * @return
               */
              setColor(color: int): RenderCommon$Rect;
               ...
               * @return
               */
              setColor(color: int, alpha: int): RenderCommon$Rect;
               ...
               * @return
               */
              setAlpha(alpha: int): RenderCommon$Rect;
               ...
               * @return
               */
              setPos(x1: int, y1: int, x2: int, y2: int): RenderCommon$Rect;
               ...
               * @return
               */
              setRotation(rotation: double): RenderCommon$Rect;
              getZIndex(): number;
             ...
             * @since 1.0.5
             */
            const RenderCommon$Text: JavaClassStatics<RenderCommon$Text, RenderCommon$Text$$constructor>;
            interface RenderCommon$Text$$constructor extends SuppressProperties {

              new (text: string, x: int, y: int, color: int, zIndex: int, shadow: boolean, scale: double, rotation: float): RenderCommon$Text;
              new (text: TextHelper, x: int, y: int, color: int, zIndex: int, shadow: boolean, scale: double, rotation: float): RenderCommon$Text;

            }
            interface RenderCommon$Text extends java.lang.Object, RenderCommon$RenderElement {
               ...
               * @throws Exception
               */
              setScale(scale: double): RenderCommon$Text;
               ...
               * @return
               */
              setRotation(rotation: double): RenderCommon$Text;
               ...
               * @return
               */
              setPos(x: int, y: int): RenderCommon$Text;
             ...
             * @since 1.2.3
             */
            const RenderCommon$Image: JavaClassStatics<RenderCommon$Image, RenderCommon$Image$$constructor>;
            interface RenderCommon$Image$$constructor extends SuppressProperties {

              new (x: int, y: int, width: int, height: int, zIndex: int, color: int, id: string, imageX: int, imageY: int, regionWidth: int, regionHeight: int, textureWidth: int, textureHeight: int, rotation: float): RenderCommon$Image;
              new (x: int, y: int, width: int, height: int, zIndex: int, alpha: int, color: int, id: string, imageX: int, imageY: int, regionWidth: int, regionHeight: int, textureWidth: int, textureHeight: int, rotation: float): RenderCommon$Image;

            }
            interface RenderCommon$Image extends java.lang.Object, RenderCommon$RenderElement {
              rotation: number;
              x: number;
              y: number;
              width: number;
               ...
               * @return
               */
              setColor(color: int): RenderCommon$Image;
               ...
               * @return
               */
              setColor(color: int, alpha: int): RenderCommon$Image;
               ...
               * @return
               */
              setRotation(rotation: double): RenderCommon$Image;
               ...
               * @param textureHeight
               */
              setImage(id: string, imageX: int, imageY: int, regionWidth: int, regionHeight: int, textureWidth: int, textureHeight: int): void;
        ...
        namespace gui {
          ...
          namespace editor {
            ...
            interface SelectCursor$$constructor extends SuppressProperties {
              ...
              new (defaultStyle: /* net.minecraft.text.Style */ any): SelectCursor;

            }
            interface SelectCursor extends java.lang.Object {
            ...
            interface History extends java.lang.Object {
          ...
          namespace editor {
            ...
            namespace highlighting {
              ...
              interface AutoCompleteSuggestion$$constructor extends SuppressProperties {
                ...
                new (startIndex: int, suggestion: string, displayText: /* net.minecraft.text.Text */ any): AutoCompleteSuggestion;

              }
              interface AutoCompleteSuggestion extends java.lang.Object {
              ...
              interface AbstractRenderCodeCompiler$$constructor extends SuppressProperties {
                ...
                new (language: string, screen: EditorScreen): AbstractRenderCodeCompiler;

              }
              interface AbstractRenderCodeCompiler extends java.lang.Object {
          ...
          namespace screens {
            ...
            interface EditorScreen$$constructor extends SuppressProperties {
              ...
              new (parent: /* net.minecraft.client.gui.screen.Screen */ any, file: java.io.File): EditorScreen;
    ...
    namespace wagyourgui {
      ...
      const BaseScreen: JavaClassStatics<BaseScreen> & NoConstructor & {
        ...
        trimmed(textRenderer: /* net.minecraft.client.font.TextRenderer */ any, str: /* net.minecraft.text.StringVisitable */ any, width: int): /* net.minecraft.text.OrderedText */ any;

      }
      interface BaseScreen extends /* net.minecraft.client.gui.screen.Screen */ JavaObject, IOverlayParent, IScreen {
    ...
    namespace wagyourgui {
      ...
      namespace overlays {
        ...
        interface OverlayContainer$$constructor extends SuppressProperties {
          ...
          new (x: int, y: int, width: int, height: int, textRenderer: /* net.minecraft.client.font.TextRenderer */ any, parent: IOverlayParent): OverlayContainer;

        }
        interface OverlayContainer extends MultiElementContainer<IOverlayParent>, IOverlayParent {
          ...
          getChildOverlay(): OverlayContainer;
          closeOverlay(overlay: OverlayContainer): void;
          setFocused(focused: /* net.minecraft.client.gui.Element */ any | null): void;
          ...
          close(): void;
          onClose(): void;
          renderBackground(matrices: /* net.minecraft.client.util.math.MatrixStack */ any): void;
          render(matrices: /* net.minecraft.client.util.math.MatrixStack */ any, mouseX: int, mouseY: int, delta: float): void;
      ...
      namespace containers {
        ...
        const MultiElementContainer: JavaClassStatics<MultiElementContainer, MultiElementContainer$$constructor>;
        interface MultiElementContainer$$constructor extends SuppressProperties {

          new <T extends IContainerParent>(x: int, y: int, width: int, height: int, textRenderer: /* net.minecraft.client.font.TextRenderer */ any, parent: T): MultiElementContainer<T>;

        }
        interface MultiElementContainer<T extends IContainerParent> extends /* net.minecraft.client.gui.DrawableHelper */ JavaObject, IContainerParent {
          readonly parent: T;
          x: number;
          y: number;
          width: number;
      ...
      namespace elements {
        ...
        interface Scrollbar$$constructor extends SuppressProperties {
          ...
          new (x: int, y: int, width: int, height: int, color: int, borderColor: int, hilightColor: int, scrollPages: double, onChange: java.util.function.Consumer<double>): Scrollbar;

        }
        interface Scrollbar extends /* net.minecraft.client.gui.widget.ClickableWidget */ JavaObject {
  ...
  namespace java {
    ...
    namespace lang {
      ...
      const Character: JavaClassStatics<Character, Character$$constructor> & {
        readonly MIN_RADIX: number;
        readonly MAX_RADIX: number;
        readonly MIN_VALUE: number;
        readonly MAX_VALUE: number;
        readonly TYPE: JavaClass<number>;
        readonly UNASSIGNED: number;
        readonly UPPERCASE_LETTER: number;
        readonly LOWERCASE_LETTER: number;
        readonly TITLECASE_LETTER: number;
        readonly MODIFIER_LETTER: number;
        readonly OTHER_LETTER: number;
        readonly NON_SPACING_MARK: number;
        readonly ENCLOSING_MARK: number;
        readonly COMBINING_SPACING_MARK: number;
        readonly DECIMAL_DIGIT_NUMBER: number;
        readonly LETTER_NUMBER: number;
        readonly OTHER_NUMBER: number;
        readonly SPACE_SEPARATOR: number;
        readonly LINE_SEPARATOR: number;
        readonly PARAGRAPH_SEPARATOR: number;
        readonly CONTROL: number;
        readonly FORMAT: number;
        readonly PRIVATE_USE: number;
        readonly SURROGATE: number;
        readonly DASH_PUNCTUATION: number;
        readonly START_PUNCTUATION: number;
        readonly END_PUNCTUATION: number;
        readonly CONNECTOR_PUNCTUATION: number;
        readonly OTHER_PUNCTUATION: number;
        readonly MATH_SYMBOL: number;
        readonly CURRENCY_SYMBOL: number;
        readonly MODIFIER_SYMBOL: number;
        readonly OTHER_SYMBOL: number;
        readonly INITIAL_QUOTE_PUNCTUATION: number;
        readonly FINAL_QUOTE_PUNCTUATION: number;
        readonly DIRECTIONALITY_UNDEFINED: number;
        readonly DIRECTIONALITY_LEFT_TO_RIGHT: number;
        readonly DIRECTIONALITY_RIGHT_TO_LEFT: number;
        readonly DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC: number;
        readonly DIRECTIONALITY_EUROPEAN_NUMBER: number;
        readonly DIRECTIONALITY_EUROPEAN_NUMBER_SEPARATOR: number;
        readonly DIRECTIONALITY_EUROPEAN_NUMBER_TERMINATOR: number;
        readonly DIRECTIONALITY_ARABIC_NUMBER: number;
        readonly DIRECTIONALITY_COMMON_NUMBER_SEPARATOR: number;
        readonly DIRECTIONALITY_NONSPACING_MARK: number;
        readonly DIRECTIONALITY_BOUNDARY_NEUTRAL: number;
        readonly DIRECTIONALITY_PARAGRAPH_SEPARATOR: number;
        readonly DIRECTIONALITY_SEGMENT_SEPARATOR: number;
        readonly DIRECTIONALITY_WHITESPACE: number;
        readonly DIRECTIONALITY_OTHER_NEUTRALS: number;
        readonly DIRECTIONALITY_LEFT_TO_RIGHT_EMBEDDING: number;
        readonly DIRECTIONALITY_LEFT_TO_RIGHT_OVERRIDE: number;
        readonly DIRECTIONALITY_RIGHT_TO_LEFT_EMBEDDING: number;
        readonly DIRECTIONALITY_RIGHT_TO_LEFT_OVERRIDE: number;
        readonly DIRECTIONALITY_POP_DIRECTIONAL_FORMAT: number;
        readonly DIRECTIONALITY_LEFT_TO_RIGHT_ISOLATE: number;
        readonly DIRECTIONALITY_RIGHT_TO_LEFT_ISOLATE: number;
        readonly DIRECTIONALITY_FIRST_STRONG_ISOLATE: number;
        readonly DIRECTIONALITY_POP_DIRECTIONAL_ISOLATE: number;
        readonly MIN_HIGH_SURROGATE: number;
        readonly MAX_HIGH_SURROGATE: number;
        readonly MIN_LOW_SURROGATE: number;
        readonly MAX_LOW_SURROGATE: number;
        readonly MIN_SURROGATE: number;
        readonly MAX_SURROGATE: number;
        readonly MIN_SUPPLEMENTARY_CODE_POINT: number;
        readonly MIN_CODE_POINT: number;
        readonly MAX_CODE_POINT: number;
        readonly SIZE: number;
        readonly BYTES: number;

        valueOf(arg0: char): number;
        hashCode(arg0: char): number;
        ...
        charCount(arg0: int): number;
        toCodePoint(arg0: char, arg1: char): number;
        codePointAt(arg0: CharSequence, arg1: int): number;
        codePointAt(arg0: char[], arg1: int): number;
        codePointAt(arg0: char[], arg1: int, arg2: int): number;
        codePointBefore(arg0: CharSequence, arg1: int): number;
        codePointBefore(arg0: char[], arg1: int): number;
        codePointBefore(arg0: char[], arg1: int, arg2: int): number;
        highSurrogate(arg0: int): number;
        lowSurrogate(arg0: int): number;
        toChars(arg0: int, arg1: char[], arg2: int): number;
        toChars(arg0: int): JavaArray<number>;
        codePointCount(arg0: CharSequence, arg1: int, arg2: int): number;
        codePointCount(arg0: char[], arg1: int, arg2: int): number;
        offsetByCodePoints(arg0: CharSequence, arg1: int, arg2: int): number;
        offsetByCodePoints(arg0: char[], arg1: int, arg2: int, arg3: int, arg4: int): number;
        ...
        toLowerCase(arg0: char): number;
        toLowerCase(arg0: int): number;
        toUpperCase(arg0: char): number;
        toUpperCase(arg0: int): number;
        toTitleCase(arg0: char): number;
        toTitleCase(arg0: int): number;
        digit(arg0: char, arg1: int): number;
        digit(arg0: int, arg1: int): number;
        getNumericValue(arg0: char): number;
        getNumericValue(arg0: int): number;
        /** @deprecated */
        ...
        getType(arg0: char): number;
        getType(arg0: int): number;
        forDigit(arg0: int, arg1: int): number;
        getDirectionality(arg0: char): number;
        getDirectionality(arg0: int): number;
        isMirrored(arg0: char): boolean;
        isMirrored(arg0: int): boolean;
        compare(arg0: char, arg1: char): number;
        reverseBytes(arg0: char): number;
        getName(arg0: int): string;
        codePointOf(arg0: string): number;

      }
      interface Character$$constructor extends SuppressProperties {

        /** @deprecated */
        new (arg0: char): number;

      }
      interface Character extends Object, java.io.Serializable, Comparable<Character>, java.lang.constant.Constable {
    ...
    namespace lang {
      ...
      namespace reflect {
        ...
        interface AccessibleObject extends java.lang.Object, AnnotatedElement {
        ...
        interface Parameter extends java.lang.Object, AnnotatedElement {
      ...
      namespace ref {
        ...
        interface ReferenceQueue<T> extends java.lang.Object {
        ...
        interface Reference<T> extends java.lang.Object {
      ...
      namespace constant {
        ...
        interface DynamicConstantDesc<T> extends java.lang.Object, ConstantDesc {
      ...
      namespace invoke {
        ...
        interface MethodHandles$Lookup extends java.lang.Object {
        ...
        interface MethodHandle extends java.lang.Object, java.lang.constant.Constable {
        ...
        interface VarHandle extends java.lang.Object, java.lang.constant.Constable {
        ...
        interface MethodType extends java.lang.Object, java.lang.constant.Constable, TypeDescriptor$OfMethod<JavaClass<any>, MethodType>, java.io.Serializable {
      ...
      namespace module {
        ...
        interface ModuleDescriptor extends java.lang.Object, java.lang.Comparable<ModuleDescriptor> {
        ...
        interface ModuleDescriptor$Opens extends java.lang.Object, java.lang.Comparable<ModuleDescriptor$Opens> {
        ...
        interface ModuleDescriptor$Requires extends java.lang.Object, java.lang.Comparable<ModuleDescriptor$Requires> {
        ...
        interface ModuleDescriptor$Exports extends java.lang.Object, java.lang.Comparable<ModuleDescriptor$Exports> {
        ...
        interface ModuleDescriptor$Version extends java.lang.Object, java.lang.Comparable<ModuleDescriptor$Version> {
        ...
        interface ModuleDescriptor$Provides extends java.lang.Object, java.lang.Comparable<ModuleDescriptor$Provides> {
        ...
        interface ModuleDescriptor$Builder extends java.lang.Object {
        ...
        interface Configuration extends java.lang.Object {
        ...
        interface ResolvedModule extends java.lang.Object {
        ...
        interface ModuleReference extends java.lang.Object {
    ...
    namespace io {
      ...
      interface OutputStream extends java.lang.Object, Closeable, Flushable {
      ...
      interface InputStream extends java.lang.Object, Closeable {
      ...
      interface Writer extends java.lang.Object, java.lang.Appendable, Closeable, Flushable {
      ...
      interface Reader extends java.lang.Object, java.lang.Readable, Closeable {
    ...
    namespace util {
      ...
      interface Locale extends java.lang.Object, java.lang.Cloneable, java.io.Serializable {
      ...
      interface Random extends java.lang.Object, java.util.random.RandomGenerator, java.io.Serializable {
      ...
      interface UUID extends java.lang.Object, java.io.Serializable, java.lang.Comparable<UUID> {
      ...
      interface Optional<T> extends java.lang.Object {
      ...
      interface Locale$LanguageRange extends java.lang.Object {
      ...
      interface IntSummaryStatistics extends java.lang.Object, java.util.function.IntConsumer {
      ...
      interface OptionalDouble extends java.lang.Object {
      ...
      interface OptionalLong extends java.lang.Object {
      ...
      interface LongSummaryStatistics extends java.lang.Object, java.util.function.LongConsumer, java.util.function.IntConsumer {
      ...
      interface OptionalInt extends java.lang.Object {
      ...
      interface DoubleSummaryStatistics extends java.lang.Object, java.util.function.DoubleConsumer {
      ...
      interface Properties extends Hashtable<java.lang.Object, java.lang.Object> {
      ...
      interface Date extends java.lang.Object, java.io.Serializable, java.lang.Cloneable, java.lang.Comparable<Date> {
      ...
      interface Dictionary<K, V> extends java.lang.Object {
      ...
      interface EventObject extends java.lang.Object, java.io.Serializable {
      ...
      interface AbstractMap<K, V> extends java.lang.Object, JavaMap<K, V> {
    ...
    namespace util {
      ...
      namespace concurrent {
        ...
        interface CompletableFuture<T> extends java.lang.Object, Future<T>, CompletionStage<T> {
    ...
    namespace net {
      ...
      interface Socket extends java.lang.Object, java.io.Closeable {
      ...
      interface SocketAddress extends java.lang.Object, java.io.Serializable {}
      ...
      interface Proxy extends java.lang.Object {
      ...
      interface InetAddress extends java.lang.Object, java.io.Serializable {
      ...
      interface SocketImpl extends java.lang.Object, SocketOptions {}
      ...
      interface NetworkInterface extends java.lang.Object {
      ...
      interface InterfaceAddress extends java.lang.Object {
      ...
      interface ServerSocket extends java.lang.Object, java.io.Closeable {
      ...
      interface DatagramSocket extends java.lang.Object, java.io.Closeable {
      ...
      interface DatagramPacket extends java.lang.Object {
      ...
      interface DatagramSocketImpl extends java.lang.Object, SocketOptions {}
    ...
    namespace math {
      ...
      interface MathContext extends java.lang.Object, java.io.Serializable {
    ...
    namespace nio {
      ...
      interface ByteOrder extends java.lang.Object {}
      ...
      interface Buffer extends java.lang.Object {
    ...
    namespace nio {
      ...
      namespace channels {
        ...
        interface AsynchronousFileChannel extends java.lang.Object, AsynchronousChannel {
        ...
        interface Selector extends java.lang.Object, java.io.Closeable {
        ...
        interface FileChannel$MapMode extends java.lang.Object {}
        ...
        interface SelectionKey extends java.lang.Object {
        ...
        interface Pipe extends java.lang.Object {
        ...
        interface FileLock extends java.lang.Object, java.lang.AutoCloseable {
        ...
        interface MembershipKey extends java.lang.Object {
      ...
      namespace channels {
        ...
        namespace spi {
          ...
          interface AbstractInterruptibleChannel extends java.lang.Object, java.nio.channels.Channel, java.nio.channels.InterruptibleChannel {
          ...
          interface SelectorProvider extends java.lang.Object {
      ...
      namespace charset {
        ...
        interface Charset extends java.lang.Object, java.lang.Comparable<Charset> {
        ...
        interface CharsetDecoder extends java.lang.Object {
        ...
        interface CharsetEncoder extends java.lang.Object {
        ...
        interface CodingErrorAction extends java.lang.Object {}
        ...
        interface CoderResult extends java.lang.Object {
      ...
      namespace file {
        ...
        interface FileSystem extends java.lang.Object, java.io.Closeable {
        ...
        interface FileStore extends java.lang.Object {
      ...
      namespace file {
        ...
        namespace spi {
          ...
          interface FileSystemProvider extends java.lang.Object {
        ...
        namespace attribute {
          ...
          interface UserPrincipalLookupService extends java.lang.Object {
          ...
          interface FileTime extends java.lang.Object, java.lang.Comparable<FileTime> {
    ...
    namespace time {
      ...
      interface Duration extends java.lang.Object, java.time.temporal.TemporalAmount, java.lang.Comparable<Duration>, java.io.Serializable {
      ...
      interface Instant extends java.lang.Object, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable<Instant>, java.io.Serializable {
      ...
      interface OffsetDateTime extends java.lang.Object, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable<OffsetDateTime>, java.io.Serializable {
      ...
      interface ZonedDateTime extends java.lang.Object, java.time.temporal.Temporal, java.time.chrono.ChronoZonedDateTime<LocalDate>, java.io.Serializable {
      ...
      interface Clock extends java.lang.Object, InstantSource {
      ...
      interface ZoneId extends java.lang.Object, java.io.Serializable {
      ...
      interface LocalDateTime extends java.lang.Object, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.time.chrono.ChronoLocalDateTime<LocalDate>, java.io.Serializable {
      ...
      interface Period extends java.lang.Object, java.time.chrono.ChronoPeriod, java.io.Serializable {
      ...
      interface LocalTime extends java.lang.Object, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable<LocalTime>, java.io.Serializable {
      ...
      interface OffsetTime extends java.lang.Object, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable<OffsetTime>, java.io.Serializable {
      ...
      interface LocalDate extends java.lang.Object, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.time.chrono.ChronoLocalDate, java.io.Serializable {
    ...
    namespace time {
      ...
      namespace temporal {
        ...
        interface ValueRange extends java.lang.Object, java.io.Serializable {
      ...
      namespace format {
        ...
        interface DateTimeFormatter extends java.lang.Object {
        ...
        interface DecimalStyle extends java.lang.Object {
      ...
      namespace chrono {
        ...
        interface AbstractChronology extends java.lang.Object, Chronology {
      ...
      namespace zone {
        ...
        interface ZoneRules extends java.lang.Object, java.io.Serializable {
        ...
        interface ZoneOffsetTransitionRule extends java.lang.Object, java.io.Serializable {
        ...
        interface ZoneOffsetTransition extends java.lang.Object, java.lang.Comparable<ZoneOffsetTransition>, java.io.Serializable {
    ...
    namespace security {
      ...
      interface ProtectionDomain extends java.lang.Object {
      ...
      interface AccessControlContext extends java.lang.Object {
      ...
      interface CodeSource extends java.lang.Object, java.io.Serializable {
      ...
      interface Permission extends java.lang.Object, Guard, java.io.Serializable {
      ...
      interface PermissionCollection extends java.lang.Object, java.io.Serializable {
      ...
      interface CodeSigner extends java.lang.Object, java.io.Serializable {
      ...
      interface Provider$Service extends java.lang.Object {
      ...
      interface Timestamp extends java.lang.Object, java.io.Serializable {
    ...
    namespace security {
      ...
      namespace cert {
        ...
        interface Certificate extends java.lang.Object, java.io.Serializable {
        ...
        interface CertPath extends java.lang.Object, java.io.Serializable {
    ...
    namespace text {
      ...
      interface ParsePosition extends java.lang.Object {
      ...
      interface Format extends java.lang.Object, java.io.Serializable, java.lang.Cloneable {
      ...
      interface FieldPosition extends java.lang.Object {
      ...
      interface AttributedCharacterIterator$Attribute extends java.lang.Object, java.io.Serializable {}
  ...
  namespace com {
    ...
    namespace mojang.brigadier {
      ...
      interface CommandDispatcher<S> extends java.lang.Object {
      ...
      interface StringReader extends java.lang.Object, ImmutableStringReader {
      ...
      interface ParseResults<S> extends java.lang.Object {
    ...
    namespace mojang.brigadier {
      ...
      namespace context {
        ...
        interface CommandContext<S> extends java.lang.Object {
        ...
        interface CommandContextBuilder<S> extends java.lang.Object {
        ...
        interface StringRange extends java.lang.Object {
        ...
        interface SuggestionContext<S> extends java.lang.Object {
        ...
        interface ParsedCommandNode<S> extends java.lang.Object {
        ...
        interface ParsedArgument<S, T> extends java.lang.Object {
      ...
      namespace tree {
        ...
        interface CommandNode<S> extends java.lang.Object, java.lang.Comparable<CommandNode<S>> {
      ...
      namespace suggestion {
        ...
        interface SuggestionsBuilder extends java.lang.Object {
        ...
        interface Suggestions extends java.lang.Object {
        ...
        interface Suggestion extends java.lang.Object, java.lang.Comparable<Suggestion> {
      ...
      namespace builder {
        ...
        interface ArgumentBuilder<S, T extends ArgumentBuilder<S, T>> extends java.lang.Object {
      ...
      namespace exceptions {
        ...
        interface SimpleCommandExceptionType extends java.lang.Object, CommandExceptionType {
        ...
        interface Dynamic2CommandExceptionType extends java.lang.Object, CommandExceptionType {
        ...
        interface DynamicCommandExceptionType extends java.lang.Object, CommandExceptionType {
    ...
    namespace google.gson {
      ...
      interface JsonElement extends java.lang.Object {
    ...
    namespace neovisionaries.ws.client {
      ...
      interface WebSocketFrame extends java.lang.Object {
      ...
      interface WebSocketExtension extends java.lang.Object {
  ...
  namespace javax {
    ...
    namespace sound.sampled {
      ...
      interface AudioFormat extends java.lang.Object {
      ...
      interface Line$Info extends java.lang.Object {
      ...
      interface Control extends java.lang.Object {
      ...
      interface Control$Type extends java.lang.Object {}
      ...
      interface AudioFormat$Encoding extends java.lang.Object {}
      ...
      interface LineEvent$Type extends java.lang.Object {}
    ...
    namespace security.auth {
      ...
      interface Subject extends java.lang.Object, java.io.Serializable {
  ...
  namespace javassist {
    ...
    interface CtClass extends java.lang.Object {
    ...
    interface CtField$Initializer extends java.lang.Object {}
    ...
    interface CodeConverter extends java.lang.Object {
    ...
    interface CtMember extends java.lang.Object {
    ...
    interface ClassMap extends java.util.HashMap<java.lang.String, java.lang.String> {
    ...
    interface ClassPool extends java.lang.Object {
    ...
    interface CtMethod$ConstParameter extends java.lang.Object {}
  ...
  namespace javassist {
    ...
    namespace util.proxy {
      ...
      interface ProxyFactory extends java.lang.Object {
    ...
    namespace bytecode {
      ...
      interface ConstPool extends java.lang.Object {
      ...
      interface MethodInfo extends java.lang.Object {
      ...
      interface ClassFile extends java.lang.Object {
      ...
      interface FieldInfo extends java.lang.Object {
      ...
      interface AttributeInfo extends java.lang.Object {
      ...
      interface CodeIterator extends java.lang.Object, Opcode {
      ...
      interface ExceptionTable extends java.lang.Object, java.lang.Cloneable {
      ...
      interface CodeIterator$Gap extends java.lang.Object {
        position: number;
        length: number;
      }
    ...
    namespace compiler {
      ...
      interface AccessorMaker extends java.lang.Object {
    ...
    namespace expr {
      ...
      interface ExprEditor extends java.lang.Object {
      ...
      interface Expr extends java.lang.Object, javassist.bytecode.Opcode {
...
type BlockDataHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.BlockDataHelper;
type BlockHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.BlockHelper;
type BlockPosHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.BlockPosHelper;
type BlockStateHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.BlockStateHelper;
type BossBarHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.BossBarHelper;
type ButtonWidgetHelper<T = /* net.minecraft.client.gui.widget.ClickableWidget */ any> = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.ButtonWidgetHelper<T>;
type ChatHistoryManager = Packages.xyz.wagyourtail.jsmacros.client.api.classes.ChatHistoryManager;
type ChatHudLineHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.ChatHudLineHelper;
...
type ClientPlayerEntityHelper<T = /* net.minecraft.client.network.ClientPlayerEntity */ any> = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.ClientPlayerEntityHelper<T>;
type CommandBuilder = Packages.xyz.wagyourtail.jsmacros.client.api.classes.CommandBuilder;
type CommandContextHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.CommandContextHelper;
type CommandManager = Packages.xyz.wagyourtail.jsmacros.client.api.classes.CommandManager;
...
type Draw3D$Box = Packages.xyz.wagyourtail.jsmacros.client.api.classes.Draw3D$Box;
type Draw3D$Line = Packages.xyz.wagyourtail.jsmacros.client.api.classes.Draw3D$Line;
type Draw3D$Surface = Packages.xyz.wagyourtail.jsmacros.client.api.classes.Draw3D$Surface;
type EditorScreen = Packages.xyz.wagyourtail.jsmacros.client.gui.screens.EditorScreen;
type EntityHelper<T = /* net.minecraft.entity.Entity */ any> = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.EntityHelper<T>;
...
type FJsMacros$EventAndContext<E extends keyof Events = 'BaseEvent'> = Packages.xyz.wagyourtail.jsmacros.core.library.impl.FJsMacros$EventAndContext & { readonly event: Events[E] };
...
type IDraw2D<T = any> = Packages.xyz.wagyourtail.jsmacros.client.api.sharedinterfaces.IDraw2D<T>;
...
type IScreen = Packages.xyz.wagyourtail.jsmacros.client.api.sharedinterfaces.IScreen;
type Inventory<T = /* net.minecraft.client.gui.screen.ingame.HandledScreen<any> */ any> = Packages.xyz.wagyourtail.jsmacros.client.api.classes.Inventory<T>;
type ItemEntityHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.ItemEntityHelper;
type ItemStackHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.ItemStackHelper;
...
type LivingEntityHelper<T = /* net.minecraft.entity.LivingEntity */ any> = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.LivingEntityHelper<T>;
...
type MerchantEntityHelper<T = /* net.minecraft.entity.passive.MerchantEntity */ any> = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.MerchantEntityHelper<T>;
...
type PlayerAbilitiesHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.PlayerAbilitiesHelper;
type PlayerEntityHelper<T = /* net.minecraft.entity.player.PlayerEntity */ any> = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.PlayerEntityHelper<T>;
type PlayerInput = Packages.xyz.wagyourtail.jsmacros.client.api.classes.PlayerInput;
type PlayerListEntryHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.PlayerListEntryHelper;
type PositionCommon$Pos2D = Packages.xyz.wagyourtail.jsmacros.client.api.sharedclasses.PositionCommon$Pos2D;
type PositionCommon$Pos3D = Packages.xyz.wagyourtail.jsmacros.client.api.sharedclasses.PositionCommon$Pos3D;
type PositionCommon$Vec2D = Packages.xyz.wagyourtail.jsmacros.client.api.sharedclasses.PositionCommon$Vec2D;
type PositionCommon$Vec3D = Packages.xyz.wagyourtail.jsmacros.client.api.sharedclasses.PositionCommon$Vec3D;
...
type RecipeHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.RecipeHelper;
type RenderCommon$Image = Packages.xyz.wagyourtail.jsmacros.client.api.sharedclasses.RenderCommon$Image;
type RenderCommon$Item = Packages.xyz.wagyourtail.jsmacros.client.api.sharedclasses.RenderCommon$Item;
type RenderCommon$Rect = Packages.xyz.wagyourtail.jsmacros.client.api.sharedclasses.RenderCommon$Rect;
type RenderCommon$RenderElement = Packages.xyz.wagyourtail.jsmacros.client.api.sharedclasses.RenderCommon$RenderElement;
type RenderCommon$Text = Packages.xyz.wagyourtail.jsmacros.client.api.sharedclasses.RenderCommon$Text;
type ScoreboardObjectiveHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.ScoreboardObjectiveHelper;
type ScoreboardsHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.ScoreboardsHelper;
type ScriptScreen = Packages.xyz.wagyourtail.jsmacros.client.api.classes.ScriptScreen;
...
type ServerInfoHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.ServerInfoHelper;
...
type TeamHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.TeamHelper;
type TextBuilder = Packages.xyz.wagyourtail.jsmacros.client.api.classes.TextBuilder;
type TextFieldWidgetHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.TextFieldWidgetHelper;
type TextHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.TextHelper;
type TradeOfferHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.TradeOfferHelper;
type VillagerEntityHelper = Packages.xyz.wagyourtail.jsmacros.client.api.helpers.VillagerEntityHelper;
type VillagerInventory = Packages.xyz.wagyourtail.jsmacros.client.api.classes.VillagerInventory;
